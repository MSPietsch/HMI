...
class Ui_wizard_2(object):
    def setupUi(self, wizard_2):
        ...
        self.label_2.setGeometry(QtCore.QRect(100, 130, 101, 59))
        font = QtGui.QFont()
        ...
        self.widget.setGeometry(QtCore.QRect(331, 115, 301, 251))
        ...
        self.widget1.setGeometry(QtCore.QRect(10, 240, 195, 74))
    ...
    def retranslateUi(self, wizard_2):
        ...
        self.label_4.setText(_translate("wizard_2", "Weitere Parameter:"))
        self.label_6.setText(_translate("wizard_2", "(werden anschließend bearbeitet)"))
