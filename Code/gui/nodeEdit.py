...
class Ui_nodeEdit(object):
    def setupUi(self, nodeEdit):
        ...
        nodeEdit.setMinimumSize(QtCore.QSize(280, 300))
        nodeEdit.setMaximumSize(QtCore.QSize(280, 300))
    ...
    def retranslateUi(self, nodeEdit):
        ...
        self.pushButton.setText(_translate("nodeEdit", "Ok"))
        self.pushButton_2.setText(_translate("nodeEdit", "Abbrechen"))
