...
class Ui_wizard_3(object):
    ...
    def retranslateUi(self, wizard_3):
        ...
        self.uberschriftLabel.setText(_translate("wizard_3", "Abweichung \"mehr Druck\" in Knoten Nr. D-1"))
        ...
        self.lineEdit_6.setPlaceholderText(_translate("wizard_3", "Weitere..."))
        self.lineEdit_4.setPlaceholderText(_translate("wizard_3", "Weitere..."))
        self.lineEdit_7.setPlaceholderText(_translate("wizard_3", "Weitere..."))
